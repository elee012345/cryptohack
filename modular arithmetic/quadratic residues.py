...
# looping through all of the ints
for i in ints:
    # checking all possibble values against all of the ints
    for j in range(1000):
        # if our brute forced value mod p is equal to i, then its a valid value
        if j**2 % p == i:
            print(str(j) + "^2 % " + str(p) + " = " + str(i))

# see how there's only a solution for one of the ints, and how that there are multiple solution for only that int
# this is described in line 24